...
2. You are asked to **maximize** the number of non-overlapping intervals or meetings.
3. You are asked to **minimize** the number of removals to resolve overlaps.
4. You are asked to find the minimum points to pierce all intervals.
...
The **Greedy Choice Property** is the theoretical backbone here. If you have two events, `A [1, 10]` and `B [2, 3]`:
...
* **If Conflict:** * Remove an interval or use an arrow.
...
| **Space Complexity** | **O(1)** | Constant space required for selection logic. |

---

# 8. Common Pitfalls

* **Sorting by Start Time:** This is for *merging* (Basic). For *selection/removal* (Intermediate), always sort by **end time**.
...
```text
2D Array of Intervals?
        ↓
Do you need to MERGE? -> Basic Intervals
        ↓
Do you need to MAXIMIZE/MINIMIZE events?
        ↓
...
# 11. Example Problem: Non-overlapping Intervals

### Intuition

To keep the maximum number of intervals, remove the minimum number of overlapping ones. By sorting by end time, we ensure we always leave as much room as possible for the next event.
...
# 12. Identifying Intermediate Problems
...
| --- | --- | --- | --- |
| 1 | Non-overlapping Intervals | Medium | [https://leetcode.com/problems/non-overlapping-intervals/](https://leetcode.com/problems/non-overlapping-intervals/) |
| 2 | Meeting Rooms I | Medium | *(LeetCode Premium)* |
| 3 | Minimum Number of Arrows to Burst Balloons | Medium | [https://leetcode.com/problems/minimum-number-of-arrows-to-burst-balloons/](https://leetcode.com/problems/minimum-number-of-arrows-to-burst-balloons/) |

---

**The Intermediate chapter is now complete and GitHub-ready. Shall we proceed to the Advanced section (Heaps and Concurrency)?**
